...
namespace ProjetDJ
{
    class Materiel
    {
        ...
        public Materiel(string idM,string nom, int puissance, string dimensions, float masse, int stock, float prixAchat, float prixLocation, float prixVente, string image)
        {
            this.idM = idM;
            this.nom = nom;
