...
namespace ProjetDJ
{
    class Clients
    {
        ...
        public Clients(string idCl,string nom, string prenom, string adresse, string ville, string codePostal, string numFixe, string numPortable, string mail, string mdp)
        {
            this.idCl = idCl;
            this.nom = nom;
            this.prenom = prenom;
