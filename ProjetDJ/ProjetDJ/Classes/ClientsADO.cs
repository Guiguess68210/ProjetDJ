...
namespace ProjetDJ
{
    class ClientsADO
    {
        public static void create(Clients clients)
        {
        ...
        public static Clients findById(string id)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    string idCl = reader["idCl"].ToString();
        ...
        public static List<Clients> readAll()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    string mail = reader["mail"].ToString();
                    string mdp = reader["mdp"].ToString();
                    clients = new Clients(idCl, nom, prenom, adresse, ville, codePostal, numfixe, numPortable, mail, mdp);
                    res.Add(clients);
                }
                cmd = null;
                reader.Close();
