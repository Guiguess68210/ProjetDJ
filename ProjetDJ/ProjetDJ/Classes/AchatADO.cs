...
namespace ProjetDJ
{
    class AchatADO
    {
        public static void create(Achat achat)
        {
            ...
            cmd.CommandText = "INSERT INTO achats (idCo, dateAchat, demandeLivraison, prixTotal, effectifMaterielTotal idCl) " +
                    "VALUES(@idCo, @dateAchat, @demandeLivraison, @prixTotal, @effectifMaterielTotal, @idCl)";
        ...
        public static bool update(Achat achat)
        {
            bool res = false;
            MySqlCommand cmd = new MySqlCommand();
            cmd.CommandText = "UPDATE Achats SET idCo = @idCo, dateAchat = @dateAchat, demandeLivraison = @demandeLivraison, prixTotal = @prixTotal, effectifMaterielTotal = @effectifMaterielTotal, idCl = @idCl WHERE idCo = @idCo";
            cmd.Parameters.AddWithValue("@idCo", achat.IdCo);
            cmd.Parameters.AddWithValue("@dateAchat", achat.DateAchat);
            cmd.Parameters.AddWithValue("@demandeLivraison", achat.DemandeL);
